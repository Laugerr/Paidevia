...
export default async function InstructorPage() {
  ...
  return (
    <div className="r-page" style={{ padding: "28px 28px 80px", maxWidth: 1100 }}>
      ...
      {/* ── Stat cards ── */}
      <div className="r-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14, marginBottom: 28 }}>
        {stats.map((s) => (
      ...
      {/* ── Main + Right panel ── */}
      <div className="r-panel-grid" style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 20, alignItems: "start" }}>

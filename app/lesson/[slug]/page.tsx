          ...
          <div className="relative grid gap-8 xl:grid-cols-[minmax(0,1.3fr)_340px] xl:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                Continue learning inside a cleaner lesson workspace built around
                focus, progress visibility, and smooth movement through the
                course roadmap.
              </p>
            ...
            <div
              className={cn(
                ...
                lessonArt[(artIndex + lessonArt.length) % lessonArt.length]
              )}
            >
